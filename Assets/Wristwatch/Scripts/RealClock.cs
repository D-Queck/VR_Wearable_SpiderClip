...
public class RealClock : MonoBehaviour {
    ...
    private Vector3 Pos,Rot,Sca = new Vector3(0f, 0f, 0f);
    private Transform transformm;

    //Use this for initialization
    private void Awake() // can be removed if the start functions works
    {
        transformm = GetComponent<Transform>();
        transformm.localPosition = new Vector3(-0.0604743622f, 0.0439282954f, -0.162937701f);
        transformm.localRotation = new Quaternion(0.62538904f, 0.16543363f, -0.683787525f, -0.337572247f);
        transformm.localScale = new Vector3(0.0237755217f, 0.0237755217f, 0.0237755217f);
    }
